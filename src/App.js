    ...
    allowedPaymentMethods: [
      {
        ...
        tokenizationSpecification: {
          ...
          parameters: {
            gateway: 'cielo',
            gatewayMerchantId: 'F8E1DE89-91FF-461B-A23C-49C96E3ECA86',
          }
        }
      }
    ],
    merchantInfo: {
      merchantId: "BCR2DN4T7KZIJ22P", //"BCR2DN4TXKT4DVC6",//"BCR2DN4T7KTLHXK6",
  ...
  return (
    <div>
      ...
      <div className="note" style={{ display: isTop ? "none" : "" }}>
        <p>
          Obs: esta página pode precisar ser aberta em uma nova janela para funcionar corretamente.
        </p>
      </div>
    </div>
  );
